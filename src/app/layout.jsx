  ...
  return (
    <html lang="en" style={{ scrollBehavior: 'smooth' }}>
      <body>
        ...
        <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 clamp(0.5rem, 2vw, 2rem)' }}>
          <div style={{ fontSize: 'clamp(0.9rem, 3.5vw, 2rem)', fontWeight: 800, fontFamily: 'var(--font-heading)', color: 'var(--color-primary)' }}>XTRA FRESH<span style={{ color: 'var(--color-secondary)' }}>!</span></div>
